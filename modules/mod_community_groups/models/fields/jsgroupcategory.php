...
class JFormFieldJsgroupcategory extends JFormField
{
    ...
    public function getInput()
    {
        ...
        $groupCategories = $model->getAllCategories();

        $value = '<option id="0">'.JText::_('MOD_COMMUNITY_GROUPS_ALL_CATEGORIES_SETTINGS').'</option>';
