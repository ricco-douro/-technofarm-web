		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="field">
				<div class="ui checkbox">
					...
					<small><?php el('Instead of keeping the multi page data set stored in session, mix it with the request data, can then be accessed using {data:param_name}'); ?></small>
				</div>
			</div>
