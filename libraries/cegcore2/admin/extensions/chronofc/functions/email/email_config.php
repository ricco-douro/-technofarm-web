	...
	<div class="ui bottom attached tab segment active" data-tab="function-<?php echo $n; ?>-general">
		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="field required">
				...
				<input type="text" placeholder="<?php el('comma separated, no spaces'); ?>" value="<?php echo \GApp::user()->get('email'); ?>" name="Connection[functions][<?php echo $n; ?>][recipients]">
			...
			<div class="field required">
				...
				<input type="text" value="New ChronoForm email received." name="Connection[functions][<?php echo $n; ?>][subject]">
