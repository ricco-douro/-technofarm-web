	...
	<div class="ui bottom attached tab segment active" data-tab="function-<?php echo $n; ?>-general">
		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="field">
				...
				<input type="text" value="<?php el('Some data is missing or incorrect.'); ?>" name="Connection[functions][<?php echo $n; ?>][error_message]">
			</div>
			...
			<div class="field required">
				...
				<small><?php el('Multiline list of field_name, validation rule and error message, if a rule accpets parameters then they can be placed between square brackets after the rule name, e.g: Field/required:Field xyz is required'); ?></small>
			</div>
