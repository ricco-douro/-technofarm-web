...
.dragged_actions{position:absolute;top:5px;right:5px;}
...
<script>
	...
	jQuery(document).ready(function($) {
		...
		*/
		...
		$('body').on('click', '.draggable-receiver-title', function(){
			var element = $(this);
		...
		*/
		$('body').on('click', function(){
			$('.clonable[data-source="1"]').not('.hidden').addClass('hidden').find(':input').prop('disabled', true);
		});
