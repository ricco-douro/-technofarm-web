	...
	<div class="ui bottom attached tab segment" data-tab="view-<?php echo $n; ?>-advanced">
		...
		<div class="equal width fields">
			...
			<div class="field">
				...
				<select name="Connection[views][<?php echo $n; ?>][calendar][size]" class="ui fluid dropdown">
				...
				<small><?php el('The size of the calendar area.'); ?></small>
			</div>
			<div class="field">
				<label><?php el('Display Mode'); ?></label>
				<select name="Connection[views][<?php echo $n; ?>][calendar][inline]" class="ui fluid dropdown">
					<option value="0"><?php el('Popup calendar'); ?></option>
					<option value="1"><?php el('Inline with field'); ?></option>
					<option value="2"><?php el('Inline without field'); ?></option>
				</select>
				<small><?php el('How the calendar is displayed on the page.'); ?></small>
			</div>
		</div>
		<div class="equal width fields">
			<div class="field">
