...
<div class="ui segment tab views-tab active" data-tab="view-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment small fields_events_list" data-tab="view-<?php echo $n; ?>-events">
		<?php $this->view(dirname(dirname(__FILE__)).DS.'field_events'.DS.'field_events_config.php', ['view' => $view, 'n' => $n, 'events_events' => ['=' => rl('Equals'), '!=' => rl('Not equals'), 'empty' => rl('Empty'), 'not_empty' => rl('Not empty'), 'regex' => rl('Matches RegEx'), 'change' => rl('Change')]]); ?>
	</div>
