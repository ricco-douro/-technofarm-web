...
<div class="ui segment tab views-tab active" data-tab="view-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment" data-tab="view-<?php echo $n; ?>-advanced">
		...
		<div class="ui header dividing"><?php el('Toolbar button settings'); ?></div>
		
		<div class="two fields">
			<div class="field">
				<label><?php el('Toolbar button'); ?></label>
				<select name="Connection[views][<?php echo $n; ?>][toolbar][enabled]" class="ui fluid dropdown">
					<option value="0"><?php el('No'); ?></option>
					<option value="1"><?php el('Yes'); ?></option>
				</select>
			</div>
			...
			<div class="field">
				...
				<select name="Connection[views][<?php echo $n; ?>][params][data-selections]" class="ui fluid dropdown">
					<option value="0"><?php el('No'); ?></option>
					<option value="1"><?php el('Yes'); ?></option>
				</select>
			</div>
		...
		<div class="field">
			<label><?php el('Selections error'); ?></label>
			<input type="text" value="<?php el('Please make a selection from the list'); ?>" name="Connection[views][<?php echo $n; ?>][params][data-message]">
		</div>
