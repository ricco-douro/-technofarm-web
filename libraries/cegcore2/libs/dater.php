...
class Dater{
	...
	public static function short($timestamp){
		if(self::datetime('Ymd', 'now', 'site') == self::datetime('Ymd', $timestamp, 'site')){
			//is today
			return self::translate(self::datetime('\{\T\o\d\a\y\} \{\a\t\} H:i', $timestamp, 'site'));
		}else if(self::datetime('Y', 'now', 'site') == self::datetime('Y', $timestamp, 'site')){
			//is this year
			return self::translate(self::datetime('{F} d \{\a\t\} H:i', $timestamp, 'site'));
		}else{
			return self::translate(self::datetime('{F} d Y', $timestamp, 'site'));
		}
	}
	...
	public static function strtotime($time, $zone = 'utc'){
		...
		return self::datetime('U', $time, $zone);
	}
