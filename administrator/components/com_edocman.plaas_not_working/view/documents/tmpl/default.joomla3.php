	...
	<div class="row-fluid">
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('JSEARCH_FILTER'); ?>" value="<?php echo $this->escape($this->state->filter_search); ?>" class="hasTooltip input-medium" title="<?php echo JHtml::tooltipText('EDOCMAN_FILTER_SEARCH_DOCUMENTS_DESC'); ?>" />
			</div>
			...
			<thead>
				<tr>
					...
					<th style="text-align: left;" width="5%">
						<?php echo JText::_('EDOCMAN_OWNER'); ?>
					</th>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td>
						...
						if($item->user_ids != "")
						{
							...
							<p class="smallsub">
								<?php
								$users = explode(",", trim($item->user_ids));
								$userArr = array();
								foreach($users as $u)
								{
