		...
		<tr>
			<td class="left">
				...
				<div class="input-prepend active">
					<span class="add-on"><span class="icon-filter"></span> <?php echo JText::_('COM_JCHAT_FILTER_BY_DATE_FROM' ); ?>:</span>
					<input type="text" name="fromperiod" id="fromPeriod" data-role="calendar" value="<?php echo $this->dates['start'];?>" class="text_area"/>
				</div>
				
				<div class="input-prepend active">
					<span class="add-on"><span class="icon-filter"></span> <?php echo JText::_('COM_JCHAT_FILTER_BY_DATE_TO' ); ?>:</span>
	...
	<table class="adminlist table table-striped table-hover">
		...
		<?php
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<div style="max-height:100px; overflow:auto"><?php echo $row->message; ?></div>
				</td>    
				<td>
