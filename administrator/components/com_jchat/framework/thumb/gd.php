 ...
 * @subpackage Core
 */
class JChatThumbGd extends JChatThumbBase
{
	/**
	 ...
	 *
	 * @see JChatThumbGd::$currentDimensions
	 */
	 ...
	 *
	 * @see JChatThumbGd::$newDimensions
	 */
