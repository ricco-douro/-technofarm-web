...
<form action="<?php echo r2('index.php?ext=chronoforms&cont=connections'); ?>" method="post" name="admin_form" id="admin_form" class="ui form">
	...
	<div class="ui">
		...
		-->
		<a class="compact ui button green blue icon labeled toolbar-button" href="<?php echo r2('index.php?ext=chronoforms&cont=connections&act=demoslist'); ?>">
			<i class="magic icon"></i><?php el('Demos'); ?>
		</a>
