...
class MPFPaymentOmnipay extends OmnipayPayment
{
	...
	{
		$Itemid = JFactory::getApplication()->input->getInt('Itemid', OSMembershipHelper::getItemid());

		$this->paymentSuccessUrl = JRoute::_(OSMembershipHelperRoute::getViewRoute('complete', $Itemid), false);
	}
