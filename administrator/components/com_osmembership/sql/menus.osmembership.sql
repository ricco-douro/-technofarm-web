...
(27, 'OSM_PURGE_URLS', 26, 'index.php?option=com_osmembership&task=tool.reset_urls', 1, 2, 'refresh'),
(28, 'OSM_FIX_DATABASE', 26, 'index.php?option=com_osmembership&task=update.update', 1, 3, 'ok'),
(29, 'OSM_SHARE_TRANSLATION', 26, 'index.php?option=com_osmembership&task=tool.share_translation', 1, 4, 'heart'),
(30, 'OSM_BUILD_EU_TAX_RULES', 26, 'javascript:confirmBuildTaxRules();', 1, 5, 'location'),
(33, 'OSM_DOWNLOAD_ID', 26, 'index.php?option=com_osmembership&view=downloadids', 1, 5, 'download');