...
class OSMembershipModelSubscriptions extends MPFModelList
{
	...
	public function __construct($config = array())
	{
		...
		$config['search_fields'] = array('tbl.first_name', 'tbl.last_name', 'tbl.organization', 'tbl.email', 'tbl.subscription_id', 'tbl.membership_id', 'tbl.transaction_id', 'c.username', 'c.name');
