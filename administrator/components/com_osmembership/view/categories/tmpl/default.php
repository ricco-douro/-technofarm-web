		...
		<table class="adminlist table table-striped" id="categoryList">
			<thead>
				<tr>
					...
					<th width="5%">
						<?php echo JHtml::_('searchtools.sort',  JText::_('JGRID_HEADING_ACCESS'), 'tbl.access', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
					</th>
			...
			for ($i=0, $n=count( $this->items ); $i < $n; $i++)
			{
				...
				$published = JHtml::_('jgrid.published', $row->published, $i, 'category.');
