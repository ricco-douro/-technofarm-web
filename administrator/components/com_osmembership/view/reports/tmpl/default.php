...
JToolBarHelper::custom('export', 'download', 'download', 'Download CSV', false);
		...
		<table class="adminlist table table-striped">
			<thead>
				<tr>
					...
					<th class="title center">
						<?php echo JHtml::_('grid.sort',  JText::_('OSM_START_DATE'), 'tbl.plan_subscription_from_date', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
						/
						<?php echo JHtml::_('grid.sort',  JText::_('OSM_END_DATE'), 'tbl.plan_subscription_to_date', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
					</th>
					<th class="title center">
			...
			for ($i=0, $n=count( $this->items ); $i < $n; $i++)
			{
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td class="center">
						<strong><?php echo JHtml::_('date', $row->plan_subscription_from_date, $this->config->date_format); ?></strong> <?php echo JText::_('OSM_TO'); ?>
						<strong>
							<?php
								...
								{
									echo JHtml::_('date', $row->plan_subscription_to_date, $this->config->date_format);
								}
							?>
						</strong>
					</td>
