 ...
 * @since  1.6
 */
class ServicesModelToken extends JModelAdmin
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_services.token';
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_services.edit.token.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__services_tokens');
				$max             = $db->loadResult();
