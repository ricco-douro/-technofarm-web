...
/**
 * Class ServicesViewSwaggerui
 * View class for a list of Services.
 * @since 1.2.8
 */
class ServicesViewSwaggerui extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_SERVICES_TITLE_SWAGGERUI'), 'swaggerui.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_services&view=swaggerui');

        $this->extra_sidebar = '';
        $jUri = new JUri();
        $this->loadJavascript($jUri->isSSL());
