					...
					<tbody>
						...
						<tr>
	                        <td class="key" width="200">
	                            <span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENT_SHOW_FILESHARING_TIPS'); ?>">
	                            <?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENT_SHOW_FILESHARING'); ?>
	                            </span>
	                        </td>
	                        <td valign="top">
	                            <?php echo CHTMLInput::checkbox('file_sharing_event' ,'ace-switch ace-switch-5', null , $this->config->get('file_sharing_event') ); ?>
	                        </td>
	                    </tr>

	                    <tr>
	                        <td class="key">
	                            <span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENT_MAX_FILESHARING_TIPS'); ?>">
	                            <?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_EVENT_MAX_FILESHARING' ); ?>
	                            </span>
	                        </td>
	                        <td valign="top">
	                            <input type="text" name="file_sharing_event_max" value="<?php echo $this->config->get('file_sharing_event_max', 0);?>" size="4" /> (MB)
	                    ...
	                    <tr>
	                        <td class="key">
	                            <span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENT_EXTENSION_FILESHARING_TIPS'); ?>">
	                            <?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_EVENT_EXTENSION_FILESHARING' ); ?>
	                            </span>
	                        </td>
	                        <td valign="top">
	                            <input type="text" name="file_sharing_event_ext" value="<?php echo $this->config->get('file_sharing_event_ext', 0);?>" size="4" />
	                        </td>
	                    </tr>
	                    <tr>
		                    <td class="key">
		                    ...
		                    <td valign="top">
		                        <input type="text" name="file_sharing_limit_per_upload_event" value="<?php echo $this->config->get('file_sharing_limit_per_upload_event', 10);?>" size="4" />
		                    </td>
		                </tr>
					</tbody>
				</table>
