			...
			<fieldset class="adminform">
				<table>
					<tbody>
						...
						<tr>
			                <td class="key">
			                    <span class="editlinktip js-tooltip" title="<?php echo Jtext::_('COM_COMMUNITY_CONFIGURATION_GROUP_SHOW_FILESHARING_TIPS')?>">
			                        <?php echo Jtext::_('COM_COMMUNITY_CONFIGURATION_GROUP_SHOW_FILESHARING')?>
			                    </span>
			                </td>
			                <td>
			                	<?php echo CHTMLInput::checkbox('file_sharing_group' ,'ace-switch ace-switch-5', null , $this->config->get('file_sharing_group') ); ?>
			                </td>
			            </tr>
						<tr>
			                <td class="key">
			            ...
			            <tr>
			             ...
			             <tr>
			                <td class="key">
			                    <span class="editlinktip js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_GROUP_FILE_SHARING_EXT_TIPS'); ?>">
									<?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_GROUP_FILE_SHARING_EXT' ); ?>
			                    </span>
			                </td>
			                <td>
								<input type="text" name="file_sharing_group_ext" value="<?php echo $this->config->get('file_sharing_group_ext' );?>" size="8" />
							</td>
			             </tr>
			            <tr>
		                    <td class="key">
		                    ...
		                    <td valign="top">
		                        <input type="text" name="file_sharing_limit_per_upload_group" value="<?php echo $this->config->get('file_sharing_limit_per_upload_group', 10);?>" size="4" />
		                    </td>
		                </tr>
					</tbody>
				</table>
