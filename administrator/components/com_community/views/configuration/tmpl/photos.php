	...
	<fieldset class="adminform">
		...
		<div class="widget-body">
			<div class="widget-main">
				<h3 class="reset-gap"><?php echo JText::_( 'COM_COMMUNITY_PHOTO_POSTBOX_CONFIG_TITLE' ); ?></h3>
                <table class="admintable" cellspacing="1">
                    <tbody>
                        <tr>
                            <td width="300" class="key">
                                <span class="js-tooltip" title="<?php echo JText::_('COM_COMMUNITY_PHOTO_POSTBOX_CONFIG_PER_UPLOAD_LIMIT_TIPS'); ?>">
                                    <?php echo JText::_( 'COM_COMMUNITY_PHOTO_POSTBOX_CONFIG_PER_UPLOAD_LIMIT' ); ?>
                                </span>
                            </td>
                            <td valign="top">
                                <input type="text" name="num_photo_per_upload_stream" value="<?php echo $this->config->get('num_photo_per_upload_stream' );?>" size="10" />
                            </td>
                        </tr>
                    </tbody>
                </table>
