...
<ol>
    ...
    <li> <?php echo JText::_('COM_COMMUNITY_TROUBLESHOOTS_CLEANUP_CHAT'); ?> <button id="clean_chat_local"><?php echo JText::_('COM_COMMUNITY_CLEAN'); ?></button><p class="clean_chat_local alert-success"></p></li>
</ol>
...
<script type="application/javascript">
    ...
    //clean orphaned chat
    $('#clean_chat_local').click(function(){
        $(this).hide();
        jax.call('community' , 'admin,troubleshoots,ajaxCleanChatOrphaned');
    });
</script>