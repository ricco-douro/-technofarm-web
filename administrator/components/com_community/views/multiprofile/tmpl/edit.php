...
<ul class="nav nav-tabs">
  <li class="active"><a href="#general" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_MULTIPLE_TAB_GENERAL');?></a></li>
  <li><a href="#fields" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_MULTIPLE_TAB_FIELDS');?></a></li>
  <li><a href="#jomsocialgroup" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_ASSIGN_TO_GROUP');?></a></li>
  <li><a href="#usergroup" data-toggle="tab"><?php echo JText::_('COM_COMMUNITY_MULTIPLE_TAB_USERGOUP');?></a></li>
</ul>
...
<div class="tab-content">
  ...
  <div class="tab-pane" id="fields">
    ...
    <div class="tab-pane" id="jomsocialgroup">
        <div class="row-fluid">
            <div class="span18">
                <table width="100%">
                    <tbody>
