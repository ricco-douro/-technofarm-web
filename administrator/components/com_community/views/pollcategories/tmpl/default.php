...
function submitbutton(action)
{
	...
	{
		azcommunity.editPollCategory( 0 , '<?php echo JText::_('COM_COMMUNITY_CATEGORY_NEW'); ?>');
	}
...
?>
			<tr>
				...
				<td>
					<?php echo JHTML::_('link', 'javascript:void(0);', $category->name, array('id' => 'group-title-' . $category->id , 'onclick'=>'azcommunity.editPollCategory(\'' . $category->id . '\',\'' . JText::_('COM_COMMUNITY_CATEGORY_EDIT') . '\');')); ?>
				</td>
...
?>
	...
	<input type="hidden" name="view" value="pollcategories" />
	<input type="hidden" name="option" value="com_community" />
	<input type="hidden" name="task" value="pollcategories" />
