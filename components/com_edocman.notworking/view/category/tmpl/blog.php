...
<div id="edocman-category-page-default" class="edocman-container">
	<form method="post" name="edocman_form" id="edocman_form" action="<?php echo JRoute::_('xxxxindex.php?option=com_edocman&view=category&layout=default&id='.$this->category->id.'&Itemid='.$this->Itemid); ?>">
		<?php
		$imgUrl = '';
		if ($this->category)
		{
			...
			<div id="edocman-category">
				<h1 class="edocman-page-heading" style="display: inline;">
					<?php
						...
						{
						?>
							<span class="edocman-rss-icon"><a href="<?php echo JRoute::_('xxxxindex.php?option=com_edocman&view=category&id='.$this->category->id.'&format=feed&type=rss'); ?>"><img src="<?php echo JUri::root().'/components/com_edocman/assets/images/rss.png' ?>" /></a></span>
						<?php
						}
						if ($user->authorise('core.create', 'com_edocman.category.'.$this->category->id))
						{
						?>
							<span style="float: right;"><a href="<?php echo JRoute::_('xxxxindex.php?option=com_edocman&view=document&layout=edit&catid=' . $this->category->id . '&Itemid=' . $this->Itemid); ?>" class="edocman_upload_link btn btn-primary"><i class="edicon edicon-upload"></i>&nbsp;<?php echo JText::_('EDOCMAN_UPLOAD'); ?></a></span>
						<?php
						}
					?>
				</h1>
