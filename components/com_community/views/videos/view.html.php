    ...
    class CommunityViewVideos extends CommunityView
    {
        ...
        public function display($id = null)
        {
            ...
            if ($groupId) {
                ...
                if ($task == 'groupvideos') {
                    $videosData = $this->getVideosShowAllVideos($cat_id, $permissions, $sorted, null, null, true);
                    ...
                    $videosData = $this->getVideosShowAllVideos($cat_id, $permissions, $sorted, null, null, false, true);
         ...
         * List All Videos
         * */
        public function getVideosShowAllVideos($category, $permissions, $sorted, $groupId = null, $eventId = null, $groupsOnly = false, $eventsOnly = false)
        {
        ...
        public function video()
        {
            ...
            if ($video->creator_type != VIDEO_GROUP_TYPE && $video->creator_type != VIDEO_EVENT_TYPE) {
                $this->attachMiniHeaderUser($video->creator);
            }
