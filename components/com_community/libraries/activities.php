...
class CActivities {
    ...
    private function _getData($options) {
        ...
        if (!empty($app)) {
            ...
            $rows = $activities->getActivities($actor, $target, $date, $maxList, $respectPrivacy, $exclusions, $displayArchived, $actid, $groupid, $eventid, $options);
        }
    ...
    public function getNewestStreamId($filter = null, $filterId = 0, $filterValue = null) {
        ...
        $result = $activitiesModel->getActivities($actor, $friendsIds, null, 1, true, null, true, null, $groupid, $eventid, $filters, true);
    ...
    public function getLatestStreamCount($id, $filter, $filterId, $filterValue) {
        ...
        $result = $activitiesModel->countActivities($actor, $friendsIds, null, 0, true, $id * (-1), true, null, $groupid, $eventid, $filters, true);
    ...
    public function getLatestStream($id, $filter, $filterId = 0, $filterValue) {
        ...
        $result = $activitiesModel->getActivities($actor, $friendsIds, null, 0, true, $id * (-1), true, null, $groupid, $eventid, $filters, true);
