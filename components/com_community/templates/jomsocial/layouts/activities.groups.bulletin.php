...
$stream->headline = '<a href="' .CUrlHelper::userLink($user->id).'">'.$user->getDisplayName(false, true).'</a> ' . JTEXT::_('COM_COMMUNITY_GROUPS_NEW_GROUP_NEWS') . '<span class="joms-stream__time"><small>' . $stream->datetime . '</small></span>';
$stream->message = "";
$stream->group = $group;
