...
?>
	...
	joms.jQuery(document).ready(function() {
		pendingText			= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_PENDING') ) );?>';
		filesExceededText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_TOO_MANY_FILES') ) );?>';
		uploadExceededText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_LIMIT_EXCEEDED') ) );?>';
		fileTooBigText		= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_FILE_TOO_BIG') ) );?>';
		unhandledErrorText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_UNHANDLED_ERROR') ) );?>';
		uploadingText		= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOADING') ) ); ?>';
		completeText		= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_COMPLETED') ) );?>';
		uploadErrorText		= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_ERROR') ) );?>';
		uploadFailedText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTO_UPLOAD_FAILED') ) );?>';
		zeroByteFileText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_ZERO_BYTE_FILE') ) );?>';
		invalidFileText		= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_INVALID_FILE_ERROR') ) );?>';
		serverErrorText		= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_UPLOAD_SERVER_IO_ERROR') ) );?>';
		securityErrorText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_UPLOAD_SECURITY_ERROR') ) );?>';
		failedValidationText= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_UPLOAD_VALIDATION_ERROR') ) );?>';
		uploadCancelledText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_UPLOAD_CANCELLED') ) );?>';
		uploadStoppedText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_UPLOAD_STOPPED') ) );?>';
		fileUploadedText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_UPLOAD_SUCCESS') ) );?>';
		filesUploadedText	= '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_PHOTOS_UPLOADED') ) );?>';
		buttonBrowseText    = '<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_BROWSE_BUTTON') ) );?>';
		...
		var settings = {
			...
			file_types_description : "<?php echo addslashes( CStringHelper::trim( JText::_('COM_COMMUNITY_ALL_IMAGE_TYPES_ALLOWED') ) ); ?>",
