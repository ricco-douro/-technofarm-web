			...
			<div class="joms-stream__container">
				<div class="joms-tab__bar">
					<?php if ($config->get('creatediscussion')) { ?>
						<a href="#joms-group--discussion" class="<?php echo ($config->get('creatediscussion')) ? 'active' : ''; ?>"><?php echo JText::_('COM_COMMUNITY_GROUPS_PARTICIPATED_DISCUSSION_UPDATE'); ?></a>
					<?php } ?>

					<?php if ($config->get('createannouncement')) { ?>
						<a href="#joms-group--announcement" class="<?php echo (!$config->get('creatediscussion')) ? 'active' : ''; ?>"><?php echo JText::_('COM_COMMUNITY_GROUPS_ANNOUNCEMENT_UPDATE_TITLE'); ?></a>
					<?php } ?>
				</div>
				<div class="joms-gap"></div>
				<?php
				...
				?>
				<?php if ($config->get('creatediscussion')) { ?>
					<div id="joms-group--discussion" class="joms-tab__content" <?php echo (!$config->get('creatediscussion')) ? 'style="display:none;"' : ''; ?>>
						<?php echo $this->view('groups')->modUserParticipatedDiscussion($userid); ?>
					</div>
				<?php } ?>

				<?php if ($config->get('createannouncement')) { ?>
					<div id="joms-group--announcement" class="joms-tab__content" <?php echo ($config->get('creatediscussion')) ? 'style="display:none;"' : ''; ?>>
