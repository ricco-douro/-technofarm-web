...
<?php
    ...
    if ($task == 'mypolls' && $my->id != $user->id) {
        $hideAddPollsButton = true;
    } else {
        $hideAddPollsButton = false;
    }
 ?>
...
<div class="joms-page">
    <div class="joms-list__search">
        ...
        <div class="joms-list__utilities">
            ...
            if ($my->authorise('community.create', 'polls') && !$hideAddPollsButton) { ?>
            <button onclick="window.location='<?php echo CRoute::_('index.php?option=com_community&view=polls&task=create'); ?>';" class="joms-button--add">
                <?php echo JText::_('COM_COMMUNITY_POLLS_CREATE_POLL'); ?>
