...
<?php } else { ?>
    ...
    <li>
        ...
        <div class="joms-popover__content">
            <h5><a href="<?php echo CUrlHelper::userLink($row->user->id); ?>"><?php echo $row->user->getDisplayName(false, true); ?></a></h5>
            <a href="<?php echo $row->link; ?>"><?php echo htmlspecialchars($row->subject); ?></a>
