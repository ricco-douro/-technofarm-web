...
<div class="joms-stream-content">
    ...
    <header>
        ...
        <?php if($user->id > 0) : ?>
            ...
            <a href="<?php echo CUrlHelper::userLink($user->id); ?>" data-joms-username class="joms-share-user"><strong><?php echo $user->getDisplayName(false, true); ?></strong></a>

        <?php else: ?>

            <strong><?php echo $user->getDisplayName(false, true); ?></strong>
