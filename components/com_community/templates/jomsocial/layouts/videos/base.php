...
<div class="joms-page joms-page--mobile">
    <div class="joms-list__search">
        ...
        <div class="joms-list__utilities">
            <?php
                ...
                if ($canCreate && ($currentTask == 'myvideos' || $addGroupVideos || $addEventVideos)) {
    ...
    <!-- sorting -->
    <?php if ($currentTask == 'display' || $currentTask == 'myvideos' || $currentTask == '' || $currentTask == 'groupvideos' || $currentTask == 'eventvideos') { ?>
        <div class="joms-sortings">
            <?php if ($currentTask != 'mypendingvideos' && $currentTask != 'search') {
                echo $sortings;
            } ?>

            <?php if (($currentTask == 'display' || $currentTask == '' || $currentTask == 'myvideos' || $currentTask == 'groupvideos' || $currentTask == 'eventvideos') && !$isGroup && !$isEvent) { ?>
