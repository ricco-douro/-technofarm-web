<?php 
// namespace administrator\components\com_jchat\views\groupchat;

/**
 * @author Joomla! Extensions Store
 * @package JCHAT::GROUPCHAT::administrator::components::com_jchat
 * @subpackage views
 ...
 * @since 2.1
 */
class JChatViewGroupchat extends JChatView {
	/**
