			...
			?>
				<div id="edocman-category">
					...
					<?php
						...
						{
						?>
							<span style="float: right;"><a href="<?php echo JRoute::_('index.php?option=com_edocman&view=document&layout=edit&catid=' . $this->category->id . '&Itemid=' . $this->Itemid); ?>" class="edocman_upload_link btn btn-success"><i class="edocman-icon-upload"></i><?php echo JText::_('EDOCMAN_UPLOAD'); ?></a></span>
						<?php                        
						}	 
					?>
					</h1>
