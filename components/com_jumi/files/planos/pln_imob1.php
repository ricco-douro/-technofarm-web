...
<div class="row3" style="padding-bottom:10px;">
	...
	<div class="column column-18 font-nexa-light"  style="padding-top:5px;">0 Fazendas</div>
</div>
<div class="row3"  style="padding-bottom:10px">
	<div class="column column-6"><img src="images/plaas/doc.svg" style="width:30px;"/></div>
	<div class="column column-18  font-nexa-light"  style="padding-top:5px;">0 Documentos</div>
</div>

<div class="row3"  style="padding-bottom:10px">
	<div class="column column-6"><img src="images/plaas/geo.svg" style="width:30px;"/></div>
	<div class="column column-18  font-nexa-light"  style="padding-top:5px;">1 arquivos GEO</div>
</div>

<div class="row3"  style="padding-bottom:10px">
	<div class="column column-6"><img src="images/plaas/car.svg" style="width:30px;"/></div>
	<div class="column column-18  font-nexa-light" style="padding-top:5px;">1 arquivos CAR</div>
</div>
</div>
