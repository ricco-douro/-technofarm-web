...
?>
<div id="osm-singup-page-columns" class="osm-container clearfix">
    ...
    <div id="osm-signup-page-columns-form">
        ...
        {
        ?>
            <div id="osm-account-information">
		        <?php echo $this->loadCommonLayout('register/tmpl/default_login.php', array('fields' => $fields)); ?>
            </div>
        <?php
        }
        else
        ...
        <form method="post" name="os_form" id="os_form" action="<?php echo JRoute::_('index.php?option=com_osmembership&task=register.process_subscription&Itemid='.$this->Itemid, false, $this->config->use_https ? 1 : 0); ?>" enctype="multipart/form-data" autocomplete="off" class="<?php echo $formHorizontalClass; ?>">
            <div id="osm-subscription-information">
			    <?php echo $this->loadCommonLayout('register/tmpl/default_form.php', array('fields' => $fields)); ?>
            </div>
            <div id="osm-payment-information">
			    <?php
