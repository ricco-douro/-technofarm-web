...
<div class="<?php echo $controlGroupClass; ?> payment_information" id="tr_card_number" <?php echo $style; ?>>
    ...
    <div class="<?php echo $controlsClass; ?>" id="sq-card-number">
        <input type="text" name="x_card_num" class="validate[required,creditCard]><?php echo $bootstrapHelper->getFrameworkClass('uk-input', 1); ?>" value="<?php echo $this->escape($this->input->post->getAlnum('x_card_num'));?>" size="20" />
    </div>
</div>
