			...
			<div id="edocman-category">
				<h1 class="edocman-page-heading" style="display: inline;">
					<?php
						...
						{
						?>
							<span style="float: right;" ><a href="<?php echo JRoute::_('index.php?option=com_edocman&view=document&layout=edit&catid=' . $this->category->id . '&Itemid=' . $this->Itemid); ?>" class="edocman_upload_link"><i class="edicon edicon-upload" style="font-size:18px; color:#196433;"></i><span style="font-size:18px; color:#196433;">&nbsp;<?php echo JText::_('EDOCMAN_UPLOAD'); ?></span></a></span>
						<?php
						}
					?>
				</h1>
