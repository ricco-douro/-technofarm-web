...
<?php
    ...
    if ($group->approvals == 0 || ($group->approvals == 1 && $isMember) || (CFactory::getUser()->authorise('community.groupeditstate', 'com_community') || CFactory::getUser()->authorise('community.groupedit', 'com_community') || CFactory::getUser()->authorise('community.groupdelete', 'com_community'))) {
        ?>
        <ul class="joms-focus__link">
            ...
            <li class="half hidden-desktop">
                ...
                <ul class="joms-dropdown more-button">
                    ...
                    <?php if ($showVideos) { ?>
                        <li class="hidden-desktop">
                            <a href="<?php echo CRoute::_('index.php?option=com_community&view=videos&groupid=display&groupid=' . $group->id); ?>">
                                <?php echo ($totalVideos == 1)
                                    ? JText::_('COM_COMMUNITY_VIDEOS_COUNT') . ' <span class="joms-text--light">' . $totalVideos . '</span>'
                                    : JText::_('COM_COMMUNITY_VIDEOS_COUNT_MANY') . ' <span class="joms-text--light">' . $totalVideos . '</span>'; ?>
                            </a>
