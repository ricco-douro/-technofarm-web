...
if ($config->show_detail_in_popup)
{
	...
	$popup      = 'class="edocman-modal ' . $btnClass . '" rel="{handler: \'iframe\', size: {x: 800, y: 500}}"';
...
<div id="edocman-documents" class="clearfix columnlayouts">
    <div class="<?php echo $rowfluidClass;?>" id="plaas-row-fluid">
	<?php
		$activeItemid = $Itemid;
		$j = 0;
		...
		for ($i = 0 , $n = count($items) ;  $i < $n ; $i++)
		{
			...
			?>
			<div class="edocman-document <?php echo $spanClass; ?>" style="min-heigth:275px;">
				<?php
				if($imgSrc != ''){
				?>
                            ...
                            <figure class="item-thumb">
                                ...
                                if ($config->use_download_link_instead_of_detail_link && $canDownload && ($accept_license == 0))
                                {
                                    if ($showDownloadForm)
                                    {
                                                ...
                                                <figcaption>
                                                    <div class="tg-featureditemcontent">
                                                        <div class="tg-border-heading">
                                                            <h3><a data-toggle="modal" data-document-title="<?php echo $item->title; ?>" title="<?php echo JText::_('EDOCMAN_DOWNLOAD'); ?>"  id="<?php echo $item->id; ?>" class="hover-effect email-popup plaas-edocman-document-title-link" href="#form-content"><i class="edicon edicon-link"></i></a></h3>
                                                        </div>
                                                    </div>
                                                </figcaption>
                                            </figure>
                                        ...
                                        <!--
                                        <a data-toggle="modal" data-document-title="<?php echo $item->title; ?>" title="<?php echo JText::_('EDOCMAN_DOWNLOAD'); ?>"  id="<?php echo $item->id; ?>" class="hover-effect email-popup plaas-edocman-document-title-link" href="#form-content">
                                        ...
                                        <div class="tg-featureditem">
                                            <figure class="tg-img-holder">
                                                ...
                                                <figcaption>
                                                    <div class="tg-featureditemcontent">
                                                        <div class="tg-border-heading">
                                                            <h3><a href="<?php echo $downloadUrl; ?>" class="hover-effect" <?php echo $popup_img; ?>>
															<i class="edicon edicon-link"></i></a></h3>
                                                        </div>
                                                    </div>
                                                </figcaption>
                                            </figure>
                ...
                <div class="item-body table-cell">
                    <!-- div class="body-left table-cell" -->
                        <!-- div class="info-row" -->
                            <h4 class="plaas-edocman-property-title property-title">
                                <?php
                                if ($config->use_download_link_instead_of_detail_link && $canDownload && ($accept_license == 0))
                                {
                                    if ($showDownloadForm)
                                    {
                                        ...
                                        <a data-toggle="modal" data-document-title="<?php echo $item->title; ?>" title="<?php echo JText::_('EDOCMAN_DOWNLOAD'); ?>"  id="<?php echo $item->id; ?>" class="email-popup edocman-document-title-link" href="#form-content">
                                            <span class="plaas-edocman-property-title"><?php echo $item->title; ?></span>
                                        </a>
                                        <?php
                                    }
                                    else
                                    {
                                        ?>
                                        <a href="<?php echo $downloadUrl; ?>" title="<?php echo JText::_('EDOCMAN_DOWNLOAD'); ?>" class="plaas-edocman-document-title-link" target="<?php echo $target;?>"><?php echo $item->title; ?></a>
                                        <?php
                                    }
                                }
                                else
